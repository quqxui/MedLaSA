    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        **optional_kwargs,
        ...
        ### derong xu
        if  lora_config.alpha_pattern == None or len(lora_config.alpha_pattern)==0:
            layer_alpha = lora_config.lora_alpha
        else:
            layer_alpha = lora_config.alpha_pattern[key]

        kwargs = {
            "r": lora_config.init_r,
            "lora_alpha": layer_alpha,
