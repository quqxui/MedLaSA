...
def main():
    ...
    mt = ModelAndTokenizer("./../../LLM_checkpoint/chatdoctor-llama", torch_dtype=torch_dtype)
    ...
    for knowledge in tqdm(knowns):
        ...
        for kind in None, "mlp", "attn":
            ...
            pdfname = f'{pdf_dir}/_{known_id}{kind_suffix}.pdf'
            # if known_id > 200:
            #     continue
...
class ModelAndTokenizer:
    ...
    def __init__(
        ...
        self.layer_names = [
            ...
            if (re.match(r"^(model|gpt_neox)\.(h|layers)\.\d+$", n))
        ]
...
def find_token_range(tokenizer, token_array, substring):
    ...
    toks = tokenizer.tokenize(whole_string)
    print(toks)
    print(whole_string)
